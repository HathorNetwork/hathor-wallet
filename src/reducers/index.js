...
const initialState = {
  ...
  proposals: {},
  /**
   * A temporary object containing the new proposal data while waiting for the unique identifier
   * to be generated by the backend. Also contains the error message, if any.
   * @type {{
   *   password: string,
   *   partialTx: string,
   *   status: string,
